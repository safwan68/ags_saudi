...
import ManpowerGrid from "../../components/Services/ManpowerGrid";
      ...
      >
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Box m={1} margin={3}>
            ...
            >
              AGS specializes in delivering comprehensive recruitment solutions
              and skilled manpower supply to the Oil & Gas and Construction
              sectors across the Eastern Province of Saudi Arabia. We also
              support the Petrochemical Industry through professional
            ...
            >
              Our capabilities cover manpower sourcing for a wide range of
              operational and technical fields, including Building Operations &
              Maintenance, Mechanical, Electrical, HVAC, Plumbing, Lifts, Waste
              Management, Pest Control, Housekeeping, Landscaping, Security,
              Project Management, Swimming Pool Maintenance, General
            ...
            >
              Whether for construction, manufacturing, maintenance, or
              large-scale industrial projects, AGS delivers dependable trading
              solutions that improve operational efficiency. With a focus on
              quality and consistency, AGS continues to be a preferred supplier
              across the Kingdom.
            </Typography> */}
          </Box>
          <ManpowerGrid />
