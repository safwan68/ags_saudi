...
import TransportGrid from "../../components/Services/TransportGrid";
      ...
      >
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Box m={1} margin={3}>
            ...
            >
              AGS delivers comprehensive transportation and logistics solutions
              to support construction, industrial, maintenance, and shutdown
              operations. We provide safe, efficient, and reliable
              transportation through a diverse and well-maintained fleet,
              supported by trained operators and structured logistics planning.
            </Typography>
            <Typography
              mt={1.5}
              sx={{
            ...
            >
              Our transportation services cover manpower movement, material
              handling, and heavy equipment logistics, ensuring timely execution
          ...
          <Box m={1} margin={3}>
            ...
            >
              We ensure reliable access solutions with full safety compliance
              and high-standard workmanship.
            </Typography>
          </Box>
        </Grid>
