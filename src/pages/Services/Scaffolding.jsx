      ...
      >
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Box m={1} margin={3}>
            ...
            >
              AGS delivers professional scaffolding services designed to support
              construction, maintenance, shutdowns, and industrial operations.
              Our scaffolding team is trained, certified, and experienced in
              working under strict safety and compliance standards, including
              Aramco and TUV requirements.
            </Typography>
          </Box>
          <ScaffoldingGrid />
          <Box m={1} margin={3}>
