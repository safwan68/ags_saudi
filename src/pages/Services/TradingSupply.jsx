      ...
      >
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Box m={1} margin={3}>
            ...
            >
              AGS provides specialized trading services, sourcing and supplying
              high-quality tools, safety gear, and industrial equipment across
              major sectors. We work with trusted global brands to ensure
              products meet international standards of reliability, durability,
              and safety.
            </Typography>
            <Typography
              mt={1.5}
            ...
            >
              Our inventory includes hand and power tools, PPE, machinery, and a
              wide range of industrial supplies—each selected to meet the
              demanding needs of field and industrial operations.
            </Typography>
            <Typography
              mt={1.5}
              sx={{
            ...
            >
              We ensure smooth procurement and timely delivery, supported by a
              dedicated logistics and customer service team that assists with
              product selection, technical details, and inventory needs.
            </Typography>
            <Typography
              mt={1.5}
              sx={{
