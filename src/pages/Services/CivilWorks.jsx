    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        <Grid size={{ xs: 12, md: 8 }}>
          <ImageStack category="civilWorks" />
          <Box m={1} margin={3}>
            <Typography
              mt={1.5}
              sx={{
            ...
            >
              AGS provides complete Civil Works solutions for industrial,
              commercial, and infrastructure projects. Our experienced team
              delivers high-quality workmanship across all phases of
              construction, maintenance, and site development. We support Oil &
              Gas, Petrochemical, Construction, and Facility Management sectors
              with reliable manpower, equipment, and execution capabilities.
            </Typography>
          </Box>
          <CivilWorkGrid />
        </Grid>
